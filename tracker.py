...
class YOLOAttributeTracker:
    ...
    def process_video(self, video_path, output_path=None, display=True, save_data=True):
        ...
        while True:
            ...
            info_text = f"People: {current_people} | Unique: {total_unique} | Frame: {frame_count}/{total_frames}"
            ...
            if display:
                cv2.imshow('YOLO Attribute Tracking', processed_frame)
...
def main():
    ...
    parser = argparse.ArgumentParser(description='People Attribute Tracker - YOLOv8 + DeepSORT + PP-Human')
    ...
    parser.add_argument('--attribute-model-path', type=str, default='models/PPLCNet_x1_0_person_attribute_945_infer', 
